...
class _CompleteProfileFormState extends State<CompleteProfileForm> {
  ...
  TextFormField buildAddressFormField() {
    return TextFormField(
      ...
      onChanged: (value) {
        if (value.isNotEmpty) {
          removeError(error: nAddressNullError);
        }
        return;
      },
      validator: (value) {
        if (value!.isEmpty) {
          addError(error: nAddressNullError);
          return "";
        }
        return null;
      },
  ...
  TextFormField buildPhoneNumberFormField() {
    return TextFormField(
      ...
      onChanged: (value) {
        if (value.isNotEmpty) {
          removeError(error: nPhoneNumberNullError);
        }
        return;
      },
      validator: (value) {
        if (value!.isEmpty) {
          addError(error: nPhoneNumberNullError);
          return "";
        }
        return null;
      },
  ...
  TextFormField buildFirstNameFormField() {
    return TextFormField(
      ...
      onChanged: (value) {
        if (value.isNotEmpty) {
          removeError(error: nNamelNullError);
        }
        return;
      },
      validator: (value) {
        if (value!.isEmpty) {
          addError(error: nNamelNullError);
          return "";
        }
        return null;
      },
